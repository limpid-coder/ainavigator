    ...
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-gray-400 text-center max-w-md">
          GPT-4 is synthesizing insights from {openEndedResponses.length} employee responses
        </p>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="glass rounded-lg p-4 border border-blue-500/20">
        <p className="text-xs text-gray-400 flex items-start gap-2">
          ...
          <span>
            This summary was generated by GPT-4 from employee open-ended responses. 
